/* Auto-generated by genmsg_cpp for file /home/danpierce/devel/ublox_test_ws/src/ublox/ublox_msgs/msg/RxmALM.msg */
...
struct RxmALM_ {
  ...
  std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  dwrd;
...
{
template<class ContainerAllocator> struct IsMessage< ::ublox_msgs::RxmALM_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::ublox_msgs::RxmALM_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
